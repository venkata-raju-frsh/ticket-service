...
ActiveRecord::Schema[7.2].define(version: 2024_09_13_052135) do
  ...
  create_table "user_role_assignments", force: :cascade do |t|
    ...
    t.index ["user_role_id"], name: "index_user_role_assignments_on_user_role_id"
  end
  ...
  add_foreign_key "user_role_assignments", "user_roles"
